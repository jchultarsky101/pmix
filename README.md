...
> **Status: 0.16.1.** `pmix` answers three questions about a STEP AP242
...
- [ ] Confirming a JT and a STEP fingerprint agree, which needs one design in both formats. The JT half is here — `nist_mtc_assembly.jt` carries precise geometry — so it is the matching **STEP** that is wanted (ADR 0011)
